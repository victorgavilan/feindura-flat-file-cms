...
// ---------- cookies settings
$langFile['ADMINSETUP_TEXT_COOKIES']                                        = 'Activa las cookies de feindura';
$langFile['ADMINSETUP_TIP_COOKIES']                                         = 'Habilita a feindura para el uso de cookies en la parte pública del sitio web. Feindura utiliza las cookies en la parte pública solo para el almacenamiento del ID de la sesión del usuario. Si se deshabilita entonces feindura tampoco utilizará sesiones en la parte pública lo que afectará levemente a las estadísticas del sitio web.';
